...
class Database{
    ...
    $username = "windhcoz_mstarztech_user";
		...
		try {
			$this->db = new PDO("mysql:host=$servername;dbname=windhcoz_mstarztech_db", $username, $password);
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="https://www.besttimelive.com/img/logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 29%;max-width: 168.2px;" width="168.2"/>
...
protected function movefiles($domain){
   ...
   private function custom_copy($src, $dst) { 
    ...
    function getaddress($data){
        ...
        if(is_array($data)){
            foreach ($data as $key => $value) {
               $c = $d->fastgetwhere($key, "ID = ?", $value, "details");
                if(is_array($c)){
                    $address .= $c['name']." ";
                }
            }
