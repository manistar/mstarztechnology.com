  ...
  font-size: 20px;
      ...
      <div class="content-wrapper">
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <!-- form start -->
                <form id="formid" role="form" method="POST" action="edit_what_i_do.php?pID=<?= $_GET['pID']; ?>" enctype='multipart/form-data'>
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                      <input type="text" name="title" class="form-control" id="" value="<?= $data['title']; ?>" placeholder="<?php echo $data['title'];?>" required/>
                  </div>

                  <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Details</label>
                      <input type="text" name="content" class="form-control" id="" value="<?= $data['content']; ?>" placeholder="Enter Title" required/>
                  </div> -->

                  <div class="form-group">
                      <label for="exampleInputPassword1">Message</label>
                      <textarea class="form-control" style="height:100px;" name="content"  id="" cols="30" rows="10"  placeholder="<?= $data['content']; ?>"> <?= $data['content']; ?></textarea>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="update_what_to" class="btn btn-primary">Add Data</button>
                  </div>
                </form> 
              </div>
