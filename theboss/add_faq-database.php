      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="add_faq.php"><i class="fa fa-book"></i> FAQ - Database</a></li>
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <form role="form" method="POST" action="add_faq.php" enctype='multipart/form-data'>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="" placeholder="Enter FAQ Question" required/>
                    </div>
                    <!--<div class="form-group">-->
              ...
              <!--                    <div id="toolbar">-->
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_faq-data" class="btn btn-primary">Add FAQ</button>
                  </div>
                </form>
              </div>
