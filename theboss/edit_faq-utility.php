      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="manage_slider.php"><i class="fa fa-book"></i> EDIT FAQ Utility</a></li>
            <li class="active"> Add FAQ Utility</li>
          </ol>
        </section>
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <form role="form" method="POST" action="edit_faq-utility.php?fID=<?= $_GET['fID']; ?>" enctype='multipart/form-data'>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_faq-utility" class="btn btn-primary">Update FAQ Utility</button>
                  </div>
                </form>
              </div>
