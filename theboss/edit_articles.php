      ...
      <div class="content-wrapper">
        ...
        <?php include('include/isset.php');
            if(isset($_GET['pID'])){
                ...
                $id = $_GET['pID'];
                $news = $d->fastgetwhere("blog", "ID = ?", $id, "details");
            }
        ?>
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Update Articles Page</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="edit_articles.php?pID=<?= $_GET['pID']; ?>" enctype='multipart/form-data'>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" style="height:100px;" name="content_brief" value="" id="" cols="30" rows="10"><?= $news['content_brief']; ?></textarea>
                    </div>
                    ...
                    <div><img style="width:100px;  height: 100px;" src="../downloads/upload/<?php echo $news['img'];?>"></div>
