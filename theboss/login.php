...
<head>
  ...
  <title>Mstarz Tech | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>MSTARZ</b> Admin Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="login.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="text"  name="adminID" value="Enter Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your ID address';}" >
        ...
        <div class="input-group mb-3">
          <input type="password" name="password" value="Password" placeholder="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" id="validatePass" >
          <div class="input-group-append">
            <div class="input-group-text">
...
<!-- This two script below are to be inserted in every page a serach ibput form is requested -->
