  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header style="background-color:#191970!important;" class="main-header">
        <!-- Logo -->
        <a style="background-color:#191970!important;" href="../" class="logo"><b>MSTARZtech ADMIN</b></a>
...
.in a:hover {
    ...
    <!-- <li class="treeview">
            ...
            <li class="treeview"><a href="../?logout"><i style="color:red;" class="fa fa-power-off"></i> Logout</a></li>
        </section>
        <!-- /.sidebar -->
      </aside>