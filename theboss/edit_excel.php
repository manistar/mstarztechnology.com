      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="manage_slider.php"><i class="fa fa-book"></i> EDIT DOC</a></li>
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <!--echo "<img src="upload/<?=$data['img'];?> alt='img'">-->
                  ...
                  <hr />
                     ...
                     <p><?= $data['doc'];?></p>
                      <label for="exampleInputFile">Upload .docx File </label>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_excel" class="btn btn-primary">Update PDF</button>
                  </div>
                </form>
              </div>
