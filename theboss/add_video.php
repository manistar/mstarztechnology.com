      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="add_video.php"><i class="fa fa-book"></i> Video</a></li>
                ...
                <form role="form" method="POST" action="add_video.php" enctype='multipart/form-data'>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="" placeholder="Enter Video Title" required/>
                    </div>
                    <!--<div class="form-group">-->
                    ...
                    <div class="modal-body">
                            <!--mytextarea-->
                     <div class="form-group">
                      <label for="exampleInputEmail1">Video Content (Full)</label>
