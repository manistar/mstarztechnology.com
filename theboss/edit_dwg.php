      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="manage_slider.php"><i class="fa fa-book"></i> EDIT DWG</a></li>
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">EDIT DWG</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="edit_dwg.php?pID=<?= $_GET['pID']; ?>" enctype='multipart/form-data'>
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">DWG Title</label>
                    ...
                    <!--</div>-->
                         ...
                         <div class="modal-body">
                            <!--mytextarea-->
                     <div class="form-group">
                      <label for="exampleInputEmail1">DWG Details</label>
                ...
                <!--echo "<img src="upload/<?=$data['img'];?> alt='img'">-->
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Upload Video Image </label>
                      <input type="file" name="img" />
                  <hr />
                  
                     <p><?= $data['dwg'];?></p>
                      <label for="exampleInputFile">Upload .mp4 File </label>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_dwg" class="btn btn-primary">Update DWG</button>
                  </div>
                </form>
              </div>
