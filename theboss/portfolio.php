...
<?php require_once 'include/isset.php';?>
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <!-- form start -->
                <form id="formid" role="form" method="POST" action="portfolio.php" enctype='multipart/form-data'>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="professions" class="form-control" id="" placeholder="Enter Professions .eg Developement or Photoshop or Web Desgin" required/>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add_portfolio" class="btn btn-primary">Add Data</button>
                  </div>
                </form> 
              </div>
