      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="manage_slider.php"><i class="fa fa-book"></i> EDIT Video</a></li>
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="edit_video.php?pID=<?= $_GET['pID']; ?>" enctype='multipart/form-data'>
                  <div class="box-body">
                    ...
                    <!--</div>-->
                         ...
                         <div class="modal-body">
                            <!--mytextarea-->
                     <div class="form-group">
                      <label for="exampleInputEmail1">Video Details</label>
                ...
                <!--echo "<img src="upload/<?=$data['img'];?> alt='img'">-->
                  ...
                  <div class="box-footer">
                    <button type="submit" name="edit_video" class="btn btn-primary">Update PDF</button>
                  </div>
                </form>
              </div>
