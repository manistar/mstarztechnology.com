  ...
  font-size: 20px;
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Upload Job Experience
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="manage_Landscape Part Ads Slider.php"><i class="fa fa-book"></i> Job Experience</a></li>
            <li class="active">Job Experience Upload</li>
          </ol>
        </section> 
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Job Experience </h3>
                </div><!-- /.box-header -->


                <!-- form start -->
                <form id="formid" role="form" method="POST" action="edit_job-exp.php?pID=<?= $data['ID']; ?>" enctype='multipart/form-data'>
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Course Of Study</label>
                      <input type="text" name="course" class="form-control" id="" value="<?= $data['course']; ?>" placeholder="Enter Education" required/>
                    </div>

                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Institute</label>
                      <input type="text" name="institute" class="form-control" id="" value="<?= $data['institute']; ?>" placeholder="Enter Institute" required/>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="update_job_ex" class="btn btn-primary">Update Job Data</button>
                  </div>
                </form>
              </div>
