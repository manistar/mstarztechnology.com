  ...
  font-size: 20px;
      ...
      <div class="content-wrapper">
        ...
        <div style="width:70%; margin-left:15%; margin-top:5%;" class="box box-primary">
                ...
                <!-- form start -->
                <form id="formid" role="form" method="POST" action="education.php?pID=<?= $data['pID']; ?>" enctype='multipart/form-data'>
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="updates_educa" class="btn btn-primary">Add Data</button>
                  </div>
                </form>
              </div>
